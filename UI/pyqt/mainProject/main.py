...
class MainWidget(QMainWindow):
    ...
    def inittoolBar(self):
        ...
        toolbarAction.triggered.connect(lambda: self.stackedWidget.setCurrentIndex(1))

        toolbarAction2 = QAction(u'金融BSJ', self)
        toolbarAction2.setStatusTip(u'新金融项目BSJ设备模拟')
        toolbarAction2.triggered.connect(lambda: self.stackedWidget.setCurrentIndex(0))
...
class OtuMonitor(MainWidget):
    ...
    def OtuMonitor_grid(self):
        # otu窗体
        self.otuWidget = QWidget()
        self.otuGrid = QGridLayout()
        self.otuWidget.setLayout(self.otuGrid)
        ...
        self.stackedWidget.addWidget(self.otuWidget)
...
class BSJMonitor(MainWidget):
    ...
    def BSJMonitor_grid(self):
        # bsj窗体
        self.bsjWidget = QWidget()
        self.bsjGrid = QGridLayout()
        self.bsjWidget.setLayout(self.bsjGrid)
        ...
        self.stackedWidget.addWidget(self.bsjWidget)
